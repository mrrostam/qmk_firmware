...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
     ...
     //|-------+-------+-------+-------+-------+-------|-------|    |-------|-------+-------+-------+-------+-------+-------|
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_LBRC,     KC_RBRC,  KC_NO,KC_UNDS,KC_PLUS,KC_LCBR,KC_RCBR,KC_PIPE,
     //|-------+-------+-------+-------+-------+-------|-------|    |-------|-------+-------+-------+-------+-------+-------|
    ...
    [_ADJUST] = LAYOUT(
     //,-------+-------+-------+-------+-------+-------.                    ,-------+-------+-------+-------+-------+-------.
          TO(_QWERTY),  TO(_COLEMAK),  KC_NO,  KC_NO,  KC_NO,  KC_NO,                       KC_NO,  KC_NO,  KC_NO, KC_NO,  KC_NO,  KC_NO,
     //|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
