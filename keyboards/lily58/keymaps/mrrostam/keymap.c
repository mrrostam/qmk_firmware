...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,  KC_Z,     KC_X,     KC_C,    KC_V,    KC_B,       KC_LBRC,      KC_RBRC,  KC_N,       KC_M,    KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT,
                                    KC_LALT, KC_LGUI, LT(_LOWER, KC_BSPC), MT(KC_LCTL, KC_SPC),       MT(KC_LALT, KC_ENT),   LT(_RAISE, KC_DEL), KC_BSPC, KC_DEL
      ),
     ...
     *                                                                               generated by [keymapviz] */
    [_RAISE] = LAYOUT(
      _______,  _______,  _______,  _______, _______, _______,                         DF(_QWERTY), DF(_COLEMAK), DF(_GAMING), _______,  _______,  QK_BOOT,
