...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT(
      ...
      _______,   _______,     _______,     _______,    _______,    _______,                               KC_DOT,       KC_Q,    KC_W,    KC_E,     KC_R,     KC_T,
      _______,  _______,     _______,     _______,    _______,    _______,                               KC_COMMA,       KC_A,    KC_S,    KC_D,     KC_F,  KC_LSFT,
      _______,  _______,     _______,     _______,    _______,    _______,       KC_LBRC,      KC_SEMICOLON,  KC_N,       KC_Z,    KC_X, KC_C,   KC_V,  KC_LCTL,
                                    KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC,       KC_LALT,   KC_TAB, KC_LCTL, MO(_RAISE)
      ),

    /* ,-----------------------------------------.                    ,-----------------------------------------.
     * | GRV  |  1   |  2   |  3   |  4   |  5   |                    |  6   |  7   |  8   |  9   |  0   | ESC  |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | TAB  |  Q   |  W   |  F   |  P   |  B   |                    |  J   |  L   |  U   |  Y   | SCLN | MINS |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | LCTL |  A   |  R   |  S   |  T   |  G   |                    |  M   |  N   |  E   |  I   |  O   | QUOT |
     * |------+------+------+------+------+------|-------.    ,-------|------+------+------+------+------+------|
     * | LSFT |  Z   |  X   |  C   |  D   |  V   | LBRC  |    | RBRC  |  K   |  H   | COMM | DOT  | SLSH | RSFT |
     * `------+------+------+------+------+------|-------/    \-------|------+------+------+------+------+------|
     *                   | LALT | LGUI |MO(_LO| / SPC   /      \ ENT   \  |MO(_RA| BSPC | RGUI |
     *                   |      |      |      |/       /        \       \ |      |      |      |
     *                   `----------------------------'          '-------''--------------------'
     ...
     * |------+------+------+------+------+------|-------.    ,-------|------+------+------+------+------+------|
     * |      |      |      |      |      |      | LBRC  |    | RBRC  |      | UNDS | PLUS | LCBR | RCBR | PIPE |
     * `------+------+------+------+------+------|-------/    \-------|------+------+------+------+------+------|
     *                   |      |      |      | /       /      \       \  |      |      |      |
     *                   |      |      |      |/       /        \       \ |      |      |      |
     *                   `----------------------------'          '-------''--------------------'
     ...
     *                                                                               generated by [keymapviz] */
    [_RAISE] = LAYOUT(
      _______,  _______,  _______,  _______, _______, _______,                         DF(_QWERTY), DF(_COLEMAK), DF(_GAMING), DF(_MAC),  _______,  QK_BOOT,
